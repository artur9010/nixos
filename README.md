...
```bash
artur9010@ramapraca: /etc/nixos git:(master) ✗ 
➜   date && flatpak list
pią, 19 wrz 2025, 16:04:12 CEST
Name                                            Application ID                                  Version                           Branch               Installation
Bazaar                                          io.github.kolunmi.Bazaar                        0.4.9                             stable               system
LinCity-NG                                      io.github.lincity_ng.lincity-ng                 2.14.0                            stable               system
Floorp                                          one.ablaze.floorp                               12.2.0                            stable               system
